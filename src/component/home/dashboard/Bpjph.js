...
const Bpjph = () => {
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#bpjph-payment-records-chart"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#bpjph-payment-records-donat"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#bpjph-payment-records-pie"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#bpjph-payment-records-piramid"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#bpjph-payment-records-barsatu"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#bpjph-payment-records-bardua"),
                chartOptions
            );
            charts.render();
