...
const Ojk = () => {
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#ojk-payment-records-chart"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#ojk-payment-records-donat"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#ojk-payment-records-pie"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#ojk-payment-records-piramid"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#ojk-payment-records-barsatu"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#ojk-payment-records-bardua"),
                chartOptions
            );
            charts.render();
            ...
            <Carousel className='custom-carousel' interval={3000}>
                ...
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card className='text-center'>
                            <Card.Body>
                                <div id='ojk-payment-records-chart'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                        ...
                        <div className='col-lg-12'>
                            <div className='row'>
                                <div className='col-lg-6'>
                                    <Card className='text-center'>
                                        <Card.Body>
                                            <div id='ojk-payment-records-donat'></div>
                                        </Card.Body>
                                    </Card>
                                </div>
                                <div className='col-lg-6'>
                                    <Card className='text-center'>
                                        <Card.Body>
                                            <div id='ojk-payment-records-pie'></div>
                                        </Card.Body>
                                    </Card>
                                </div>
                            </div>
                ...
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card>
                            <Card.Body>
                                <div id='ojk-payment-records-piramid'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card>
                            <Card.Body>
                                <div id='ojk-payment-records-barsatu'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card>
                            <Card.Body>
                                <div id='ojk-payment-records-bardua'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
