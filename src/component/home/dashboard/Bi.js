...
const Bi = () => {
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#bi-payment-records-chart"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#bi-payment-records-donat"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#bi-payment-records-pie"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#bi-payment-records-piramid"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#bi-payment-records-barsatu"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#bi-payment-records-bardua"),
                chartOptions
            );
            charts.render();
            ...
            <Carousel className='custom-carousel' interval={3000}>
                ...
                <Carousel.Item>
                    <div className='col-lg-12 chart-container'>
                        <Card className='d-flex justify-content-center'>
                            <Card.Body>
                                <div id='bi-payment-records-chart'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='row col-lg-12 chart-container'>
                        ...
                        <Card className='col-md-12 col-lg-6'>
                            <Card.Body className='p-0 p-lg-3'>
                                <div id='bi-payment-records-pie'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12 chart-container'>
                        <Card>
                            <Card.Body>
                                <div id='bi-payment-records-piramid'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12 chart-container'>
                        <Card>
                            <Card.Body>
                                <div id='bi-payment-records-barsatu'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12 chart-container'>
                        <Card>
                            <Card.Body>
                                <div id='bi-payment-records-bardua'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
