...
const Kneks = () => {
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#kneks-payment-records-chart"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#kneks-payment-records-donat"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const chart = new window.ApexCharts(
                document.querySelector("#kneks-payment-records-pie"),
                chartOptions
            );
            chart.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#kneks-payment-records-piramid"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#kneks-payment-records-barsatu"),
                chartOptions
            );
            charts.render();
    ...
    useEffect(() => {
        ...
        if (window.ApexCharts) {
            ...
            const charts = new window.ApexCharts(
                document.querySelector("#kneks-payment-records-bardua"),
                chartOptions
            );
            charts.render();
            ...
            <Carousel className='custom-carousel' interval={3000}>
                ...
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card className='text-center'>
                            <Card.Body>
                                <div id='kneks-payment-records-chart'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                ...
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card>
                            <Card.Body>
                                <div id='kneks-payment-records-piramid'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card>
                            <Card.Body>
                                <div id='kneks-payment-records-barsatu'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className='col-lg-12'>
                        <Card>
                            <Card.Body>
                                <div id='kneks-payment-records-bardua'></div>
                            </Card.Body>
                        </Card>
                    </div>
                </Carousel.Item>
