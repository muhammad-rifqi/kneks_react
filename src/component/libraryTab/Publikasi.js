                ...
                <Row className="d-flex justify-content-end">
                    ...
                    <Col lg={{ span: 7 }}>
                        <Form.Control
                            ...
                            style={{ padding: '9px 20px', borderRadius: '4px', border: '1px solid #ccc', marginBottom: '12px', outline: 'none' }} placeholder="Cari Publikasi..." />
                    </Col>
                    <Col lg={{ span: 1 }}>
                ...
                <div className="col-12 col-md-6 col-xl-3">
                    <div className="team-card-x">
                        ...
                        <div className="team-card-content-x">
                            <h4><a href="/e-pustaka/detail">Publikasi Ekonomi Syariah Indonesia 2014 - 2019</a></h4>
