                ...
                <section className="about-one-section">
                    <div className="container">
                        <div className="row row-gutter-y-40">
                            ...
                            <div className="col-lg-12 col-xl-6">
                                <div className="about-one-inner">
                                    ...
                                    <p className="text-justify">
                                        Komite Nasional Ekonomi dan Keuangan Syariah (KNEKS) merupakan perubahan dari KNKS untuk peningkatan pembangunan ekosistem ekonomi dan keuangan syariah serta menjadikan Indonesia sebagai Pusat Halal Dunia.<br />
                            ...
                            <div className="col-lg-12 col-xl-6">
                                <div className="about-one-image">
                                    <img src="assets/image/poto-sj.svg" alt="img-59" className="img-fluid" />
                                </div>
                            </div>
                            <div className="col-lg-12 col-xl-6">
                                <div className="about-one-image">
                                    <img src="assets/image/poto-hk.svg" alt="img-59" className="img-fluid" />
                                </div>
                            </div>
                            <div className="col-lg-12 col-xl-6">
                                <div className="about-one-inner ">
