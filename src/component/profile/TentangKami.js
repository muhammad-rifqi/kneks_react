                ...
                <section className="about-one-section">
                    <div className="container">
                            ...
                            <div className="col-lg-12 col-xl-6">
                                ...
                                <div className="col-lg-12 col-xl-12">
                                    <div className="about-one-inner text-center">
                                        <h2 className="section-title text-center">Tugas KNEKS</h2>
                                        <p className="text-justify">
                                ...
                                <div className="col-lg-12 col-xl-12">
                                    <div className="about-one-inner ">
                                        <h2 className="section-title text-center">Fungsi KNEKS</h2>
                        ...
                        <div className="row row-gutter-y-40">
                            ...
                            <div className="col-lg-12 col-xl-6">
                                <div className="about-one-image">
                                    <img src="assets/image/gallery/grahadi.jpeg" alt="img-59" className="img-fluid" />
                                </div>
                            </div>
