        ...
        if (effectrun.current === false) {
            const fetchPosts = async () => {
                try {
                    ...
                    const responsei = await axios.get(`${url}/hotissuedetail/${atob(id)}`);
                                    ...
                                    <div className="col-lg-4 col-xl-4" key={item.id}>
                                        <div className="berita-card">
                                            <div className="berita-card-imgbox ">
                                                <a href={`/isu-terkini/${btoa(item.id)}/${convertToSlug(item.title)}`}>
                                                    <img
                                            ...
                                            <div className="berita-content ">
                                                ...
                                                <div className="event-card-title pb-4">
                                                    <h4>
                                                        <a href={`/isu-terkini/${btoa(item.id)}/${convertToSlug(item.title)}`}>{item.title}</a>
                                                    </h4>
                                                </div>
...
export default IsuTerkiniDetail