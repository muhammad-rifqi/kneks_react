            ...
            <div id="dwnjpg">
                ...
                <div className="card stretch stretch-full">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <h5 className="card-title">Percepatan Export Industri Halal</h5>
                    ...
                    <div className="card-body custom-card-action p-0" id="dwnjpg">
                        <iframe src="https://metabase.kneks.go.id/public/dashboard/ce46adac-1bb6-41e2-b66e-4e207013821b" title="iframe1" width={`100%`} height="1000"
...
export default PercepatanExport;