            ...
            <div id="dwnjpg">
                    ...
                    <Card.Body>
                        <Row >
                            <Breadcrumb as={Col} className="">
                                <Breadcrumb.Item active>Insis</Breadcrumb.Item>
                ...
                <div className="card stretch stretch-full">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <h5 className="card-title">Insis</h5>
                    ...
                    <div className="card-body custom-card-action p-0" id="dwnjpg">
                        <iframe src="https://metabase.kneks.go.id/public/dashboard/90aaae48-9de6-4e58-8d76-c73c13be83ac" title="iframe1" width={`100%`} height="1000"
